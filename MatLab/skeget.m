function [endpoint] skeget(mainske, ske, ep, jp, r)
    ...
    for i = 1 : length(stats)
        ...
        plot(centerpoint(1), centerpoint(2), '*y', 'MarkerSize',3);            
        ...
        plot(headpoint(1), headpoint(2), '*g', 'MarkerSize',3);
        %Plots a red dot at the tail
        plot(tailpoint(1), tailpoint(2), '*r', 'MarkerSize',3);
